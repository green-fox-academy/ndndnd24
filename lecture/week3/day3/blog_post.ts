...
let loremIpsum: BlogPost = new BlogPost('John Doe', 'Lorem Ipsum', 'Lorem ipsum dolor sit amet.', '2000.05.04');
let waitButWhy: BlogPost = new BlogPost('Tim Urban', 'Wait but why?', 'A popular long - form, stick - figure - illustrated blog about almost everything.', '2010.10.10');
